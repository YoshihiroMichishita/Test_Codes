...
int main(int argc, char* argv[]){
    ...
    #pragma omp parallel for num_threads(52) reduction(+: XX_sum,YX_sum,YXXr_sum,YXXr2_sum,YXXi_sum,YXXi2_sum,XX_sum2,YX_sum2,YXXr_sum2,YXXr2_sum2,YXXi_sum2,YXXi2_sum2)
    for (int WW = 0; WW < parm_.W_SIZE-1; WW++){
        ...
        for (int i = 0; i < parm_.K_SIZE; i++){
            ...
            for (int j = 0; j < parm_.K_SIZE; j++){
                ...
                Linear_transport_NH(dw,w[WW],parm_.delta,parm_.T,Ham_,XX,YX,YXXr,YXXr2,YXXi,YXXi2,XX_,YX_,YXXr_,YXXr2_,YXXi_,YXXi2_);
            }
