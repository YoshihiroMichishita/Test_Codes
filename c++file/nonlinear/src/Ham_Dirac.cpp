...
void H_mom(parm parm_, double k[D], Complex H[M*M]){
    ...
    double s_y = parm_.t_i * s(k[1]);
    double s_z = parm_.mu + parm_.t_i * (c(k[0])+c(k[1])+c(k[2]));
    double s_0 = parm_.t_e * s(k[2]);
...
void H_mom_BI(parm parm_, double k[D], Complex H[M*M], Complex VR_k[M*M], Complex VL_b[M*M], double E[M]){
    double s_x = parm_.t_i * s(k[0]);
    double s_y = parm_.t_i * s(k[1]);
    double s_z = parm_.Ma + parm_.t_i * (c(k[0])+c(k[1])+c(k[2]));
    double s_0 = parm_.mu + parm_.t_e * s(k[2]);
...
void H_mom_NH(parm parm_, double k[D], Complex H[M*M], Complex VR_k[M*M], Complex VR_b[M*M], Complex VL_k[M*M],Complex VL_b[M*M],Complex E_NH[M]){
    ...
    H[0] = s_z + s_0 + I*parm_.NH - I*parm_.delta; H[1] = s_x - I * s_y;
    H[2] = s_x + I * s_y; H[3] = s_z + s_0 - I*parm_.NH - I*parm_.delta;
...
void Vy(parm parm_, double k[D],Complex H[M*M]){
    double s_x = 0;
    double s_y = parm_.t_i * c(k[1]);
    double s_z = -parm_.t_i * s(k[1]);
    double s_0 = 0;
