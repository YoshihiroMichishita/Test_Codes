...
void H_mom_NH(parm parm_, double k[D], Complex H[M*M], Complex VR_k[M*M], Complex VR_b[M*M], Complex VL_k[M*M],Complex VL_b[M*M],Complex E_NH[M]){
    ...
    H[0] = s_z + s_0 - I*parm_.delta; H[1] = s_x - I * s_y; H[2] = Vk; H[3] = 0;
    H[4] = s_x + I * s_y; H[5] = -s_z + s_0 - I*parm_.delta; H[6] = 0; H[7] = Vk;
    H[8] = Vk; H[9] = 0; H[10] = (-s_z+s_0) - I*parm_.delta; H[11] = -(s_x - I * s_y);
    H[12] = 0; H[13] = Vk; H[14] = -(s_x + I * s_y); H[15] = s_z + s_0 - I*parm_.delta;
