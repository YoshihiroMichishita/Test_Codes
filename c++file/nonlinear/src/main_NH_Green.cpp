...
int main(int argc, char* argv[]){
    ...
    cout << "YXX " << YXXr_sum << "\t" << YXXi_sum << "\t" << YXXr2_sum << "\t" << YXXi2_sum << endl;
    cout << "=============================" << endl;
    cout << parm_.mu << "\t" << XX_sum << "\t" << YX_sum << "\t" << 2.0*YXXi_sum+YXXi2_sum
     << "\t" << XX_sum2 << "\t" << YX_sum2 << "\t" << 2.0*YXXi_sum2+YXXi2_sum2 << endl;
    
    out3 << parm_.NH << "\t" << parm_.alpha << "\t" << XX_sum << "\t" << YX_sum << "\t"
     << "\t" << YXXi_sum << "\t" << YXXi2_sum << "\t" << YXXr_sum << "\t" << YXXr2_sum << "\t" << 2.0*YXXi_sum+YXXi2_sum << endl;
